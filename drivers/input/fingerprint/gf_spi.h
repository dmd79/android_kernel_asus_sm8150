...
#define GF_NAV_INPUT_UP		KEY_A
#define GF_NAV_INPUT_DOWN		KEY_B
#define GF_NAV_INPUT_LEFT		KEY_D
#define GF_NAV_INPUT_RIGHT		KEY_R
#define GF_NAV_INPUT_CLICK		KEY_X
#define GF_NAV_INPUT_DOUBLE_CLICK	KEY_F18
#define GF_NAV_INPUT_LONG_PRESS	KEY_F19
